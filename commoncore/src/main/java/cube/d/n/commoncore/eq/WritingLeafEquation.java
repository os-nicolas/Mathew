...
public class WritingLeafEquation extends LeafEquation implements LegallityCheck {
    public WritingLeafEquation(String display, BaseView emilyView) {
        super(emilyView);
        init(display);
    }
    ...
    public WritingLeafEquation(String display, BaseView owner, WritingLeafEquation equations) {
    ...
    public Equation copy() {
        Equation result = new WritingLeafEquation(this.display, this.owner,this);
        return result;
    }
