...
public class WritingPraEquation extends WritingLeafEquation {
    ...
    public WritingPraEquation(boolean left, InputLine emilyView) {
    ...
    public WritingPraEquation(boolean left, InputLine owner, WritingPraEquation equations) {
    ...
    public Equation copy() {
        Equation result = new WritingPraEquation(this.left, (InputLine)this.owner, this);
        return result;
    }
    ...
    public Equation popBlock() {
        ...
        if (this.parent instanceof MultiEquation) {
            ...
            toSelect = new WritingEquation((InputLine)owner);
        }
        if (toSelect == null) {
