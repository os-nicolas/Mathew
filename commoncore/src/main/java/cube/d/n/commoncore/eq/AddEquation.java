...
public class AddEquation extends FlexOperation {
    ...
    public AddEquation(BaseView owner, AddEquation addEq){
        super(owner, addEq);
        init();
	...
	public AddEquation(BaseView owner) {
		super(owner);
        init();
	}
    ...
    protected float myWidthAdd() {
        return (float) (16* BaseApp.getAlgebrator().getDpi()*BaseApp.getAlgebrator().zoom);
    }
